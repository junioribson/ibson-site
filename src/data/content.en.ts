...
export const talks = {
  ...
  faq: [
    ...
    { q: "Does Ibson Junior speak across Brazil? And online?", a: "Yes. Ibson Junior gives in-person talks across Brazil and also online. Date, format and logistics for each event are agreed in the proposal." },
