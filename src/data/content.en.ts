...
export const talks = {
  ...
  geoNote: "Based in Porto Alegre (Brazil), for events across the country (in person) and also online.",
  faq: [
    { q: "What is an executive keynote speaker?", a: "A professional who brings leaders and teams topics of decision, communication, culture and strategy with depth and judgment, without empty motivational appeal. Ibson Junior works in this format, connecting real executive repertoire to the room." },
    { q: "What topics does Ibson Junior speak about?", a: "Deciding under pressure, AI with human judgment, communication and content, organizational culture, governance and leadership. Topics adapt to the moment of the company and the audience." },
    { q: "How do I book a talk with Ibson Junior?", a: "Through the site's contact form or by email at contato@ibsonjunior.com.br. Just share the event, audience, date and desired format and we reply with availability and a proposal." },
    { q: "Does Ibson Junior speak across Brazil? Does he do online talks?", a: "Yes. He is based in Porto Alegre (Brazil), with in-person talks across the country (travel covered) and online talks when it fits the event." },
...
export const mentorship = {
  ...
  faq: [
    { q: "What is executive mentoring?", a: "A one-on-one process that turns experience into clarity: reviewing the journey, adjusting positioning and narrative, and defining the next moves with more judgment. It is not a course or a ready-made formula." },
    ...
    { q: "Who is the mentoring for?", a: "For leaders, managers, specialists and executives growing or in transition who already have a story and want to organize positioning, presence and next steps with more awareness." },
    { q: "Is the mentoring online?", a: "Yes. The mentoring is one-on-one and conducted online." },
