...
export const seo = {
  ...
  description:
    "Ibson Junior: content, leadership and communication executive. Talks, mentoring and advisory on personal branding, communication, culture and decision.",
  ogTitle:
...
export const about = {
  ...
  body: [
    '<strong>Ibson Lima dos Santos Junior</strong>, known professionally as <a href="https://www.linkedin.com/in/ibson-junior/" target="_blank" rel="noopener">Ibson Junior</a>, is a <strong>content, leadership and communication executive</strong>, with a path built across digital media, editorial strategy, culture, digital business and audience building.',
...
export const cases = {
  ...
  wolflife: {
    ...
    provas: [
      { n: "+160M", t: "followers on the network" },
      { n: "+15B", t: "impressions" },
      { n: "785M", t: "reach per month" },
...
export const talks = {
  ...
  positioning: {
    ...
    text: "Ibson Junior is an executive and strategic keynote speaker, based in Porto Alegre and working across Brazil. He brings to companies, events and leadership teams, in person or online, corporate talks and keynotes on deciding under pressure, artificial intelligence with human judgment, communication, culture and leadership. It is the work of a corporate speaker with the depth of someone who built and led large-scale content operations.",
  },
  ...
  faq: [
    ...
    { q: "What topics does Ibson Junior speak about?", a: "Deciding under pressure, AI with human judgment, communication and content, organizational culture, governance and leadership. There are talks on artificial intelligence and on leadership that adapt to the moment of the company and the audience." },
    { q: "How do I hire Ibson Junior as a speaker?", a: "To hire the speaker, use the site's contact form or email contato@ibsonjunior.com.br. Just share the event, audience, date and desired format and we reply with availability and a proposal." },
    { q: "How much does it cost to book a corporate talk?", a: "The investment depends on the format, duration and logistics of the event, in person or online. There is no table price: from the event briefing, you receive a clear proposal with availability and scope." },
    { q: "Does Ibson Junior speak across Brazil? And online?", a: "Yes. Based in Porto Alegre, Ibson Junior works as a speaker across Brazil, in person, and also online. Date, format and logistics for each event are agreed in the proposal." },
    { q: "What are the formats and durations?", a: "Talk, panel, executive roundtable, workshop, special lecture and leadership conversation, in 45, 60 or 90 minutes, depending on the goal of the gathering." },
    { q: "What is the difference between an executive and a motivational talk?", a: "The motivational one seeks momentary energy. The executive one organizes a real concern and delivers judgment to decide and communicate better after the event. The focus is clarity that lasts, not passing stimulus." },
  ],
};
...
export const mentorship = {
  ...
  faq: [
    { q: "What is executive mentoring?", a: "A one-on-one process, led by an executive mentor, that turns experience into clarity: reviewing the journey, adjusting positioning and narrative, and defining the next moves with more judgment. It is not a course or a ready-made formula, it is direction built from your real moment." },
    { q: "How does Ibson Junior's mentoring work?", a: "It starts with a diagnosis and leads a strategic conversation on personal brand, executive communication, strategic LinkedIn, narrative and personal governance, always linking perceived value to concrete decisions." },
    { q: "Who is the mentoring for?", a: "It is mentoring for executives, leaders, managers and specialists growing or in transition who already have a story and want to organize positioning, presence and next steps with more awareness. It works as leadership and executive career mentoring." },
    { q: "How much does executive mentoring cost?", a: "The investment depends on the scope, which emerges from the diagnosis and your professional moment. There is no fixed package: after the first conversation, you receive a clear proposal with format and cadence." },
    { q: "Is the mentoring online? Does it serve all of Brazil?", a: "Yes. The mentoring is one-on-one and conducted online, serving professionals across Brazil, based in Porto Alegre." },
    { q: "What is the format and duration?", a: "The scope emerges from the diagnosis and the professional moment. There is no generic package: format and cadence adjust to what needs to change." },
    { q: "What is the difference between mentoring and coaching?", a: "Coaching works on process and behavior more broadly. Ibson Junior's mentoring starts from real executive repertoire in leadership, content, communication and decision, to give practical direction from lived experience." },
  ],
};
