...
Hay un problema estructural que atraviesa empresas de diferentes tamaños y niveles de madurez, pero que tiende a ser subestimado: la existencia de **silos comunicacionales.** Esa incomunicación puede aparecer tanto entre áreas como en la cascada de información entre diferentes niveles dentro del mismo equipo, y puede adquirir dimensiones aún más relevantes cuando ocurre entre matriz y filiales, o entre instancias globales y locales de la misma empresa. En la práctica, los efectos son siempre mayores de lo que parecen y están directamente ligados tanto a la **gobernanza** como **[a la](https://www.linkedin.com/pulse/cultura-n%25C3%25A3o-%25C3%25A9-powerpoint-mas-energia-vital-que-sustenta-ibson-junior-lpiwf/?trackingId=mm%2FeR0rvQ0qfghk7p%2BtSiA%3D%3D&trk=article-ssr-frontend-pulse_little-text-block)** **[cultura](https://www.linkedin.com/pulse/cultura-n%25C3%25A3o-%25C3%25A9-powerpoint-mas-energia-vital-que-sustenta-ibson-junior-lpiwf/?trackingId=mm%2FeR0rvQ0qfghk7p%2BtSiA%3D%3D&trk=article-ssr-frontend-pulse_little-text-block)** como uno de los principales motores del crecimiento individual, de los equipos y de la institución.
...
<figure class="art-fig"><img src="/assets/artigos/inline/ibson-junior-comunicacao-framework-estrategico-playbook-operacao.webp" alt="Diagrama que compara el framework estratégico (visión, estrategia, metas y prioridades) y el playbook de la operación, un equipo en reunión. Ilustración del artículo de Ibson Junior sobre comunicación y gobernanza." loading="lazy" width="615" style="max-width:615px" height="400" /></figure>
