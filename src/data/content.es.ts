...
export const talks = {
  ...
  faq: [
    ...
    { q: "¿Ibson Junior da charlas en todo Brasil? ¿Y online?", a: "Sí. Ibson Junior da charlas presenciales en todo Brasil y también en formato online. Fecha, formato y logística de cada evento se acuerdan en la propuesta." },
